...
class Competitors < ActiveRecord::Base
	...
	validates_length_of :telephone, :is => 11, :message => "11 szám szükséges, 0 helyett 3-mal kezdve!", :wrong_length => "11 szám szükséges, 0 helyett 3-mal kezdve!"
	validates_length_of :zipcode, :is => 4, :message => "4 szám szükséges!", :wrong_length => "4 szám szükséges!"
	validates_numericality_of :telephone, :only_integer => true, :message => "Csak számok!"
